...
export function DesignSystemColorTokensSection() {
  return (
    <section className="rounded-lg border border-border bg-surface p-5">
      <h2 className="text-title-1 text-foreground-title">Color tokens</h2>
      ...
      <div className="mt-8 grid gap-6">
        <div>
          <h3 className="text-title-3 text-foreground-title">Legacy — main colors</h3>
        ...
        <div>
          <h3 className="text-title-3 text-foreground-title">Legacy — utility colors</h3>
