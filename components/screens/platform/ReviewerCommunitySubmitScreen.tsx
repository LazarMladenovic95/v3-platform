...
export function ReviewerCommunitySubmitScreen() {
  ...
  const [matchedProduct, setMatchedProduct] =
    useState<CommunityProductFixture | null>(null);
          ...
          {step === "rating" && matchedProduct ? (
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                />
                {ratingError ? (
                  <HintText className="text-destructive">
                    {ratingError}
                  </HintText>
                ) : null}
              </div>
...
function MatchedProductSummary({
  product,
}: {
  product: CommunityProductFixture;
}) {
  return (
    <div className="rounded-lg border border-border bg-surface-muted p-4">
      <Text variant="body-extra-small-muted">
        {t("app.reviewerCommunitySubmit.matched.label")}
      </Text>
      <Text
        variant="body-small"
        className="mt-1 text-body-small-bold text-foreground-title"
      >
  ...
  return (
    <div>
      ...
      <dd>
        <Text
          variant="body-small"
          className="mt-0.5 text-body-small-bold text-foreground-title"
        >
          {value}
        </Text>
      </dd>
